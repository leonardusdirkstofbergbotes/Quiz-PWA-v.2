...
export default {
  ...
  data () {
    return {
      quizCards: [
        ...
        {category: 'Celebrites', img: 'https://thumbs.dreamstime.com/z/celebrities-couple-walking-red-carpet-vector-illustration-people-marriage-two-actor-wedding-70223496.jpg', free: true}
      ]
    }
  },
  ...
  methods: {
    selectCategory(category) {
      this.$router.push('/quiz/'+ category)
    }
  }
}
</script>
